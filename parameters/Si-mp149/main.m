...
T = 1 / 0.529 * a * [
    4.37707054e-16 2.72185118e+00 2.72185118e+00;
    2.72185118e+00 0.00000000e+00 2.72185118e+00;
    2.72185119e+00 2.72185118e+00 3.33330634e-16;
];  
...
alpha = 2.1;
potential = {
    1, -Z_eff/r * exp(-alpha*r);
    2, -Z_eff/r * exp(-alpha*r);
    };  
...
filename = sprintf('Si，alpha=%g，速度核验', alpha);  % 项目名称
